...
test("creating a table sends the choice and joining mounts the live table", async () => {
  ...
  socket.push({
    ...
    view: {
      ...
      explain: [],
      seats: [
        { id: 0, name: "sabien", bankroll: 25_000_000, staked: 0, sitting_out: false, ready: false, decided: false },
      ],
...
test("renaming at the table goes over the wire and sticks for next time", async () => {
  ...
  socket.push({
    ...
    view: {
      ...
      explain: [],
      seats: [
        { id: 0, name: "guest", bankroll: 25_000_000, staked: 0, sitting_out: false, ready: false, decided: false },
      ],
      player_squeezer: null,
      banker_squeezer: null,
    },
...
test("the room code copies to the clipboard", async () => {
  ...
  socket.push({
    ...
    view: {
      ...
      explain: [],
      seats: [{ id: 0, name: "me", bankroll: 50_000, staked: 0, sitting_out: false, ready: false, decided: false }],
      player_squeezer: null,
      banker_squeezer: null,
    },
  });
...
describe("join-path analytics", () => {
  ...
  function emptyView(name: string) {
    return {
      ...
      explain: [],
      seats: [{ id: 0, name, bankroll: 25_000_000, staked: 0, sitting_out: false, ready: false, decided: false }],
      player_squeezer: null,
      banker_squeezer: null,
    };
  }
